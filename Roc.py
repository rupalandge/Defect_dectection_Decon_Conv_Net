...
VOC_2013_images_dir = 'D:/3/ssd_keras_1_master/datasets1/VOCdevkit/VOC2007/JPEGImages/'
VOC_2013_annotations_dir = 'D:/3/ssd_keras_1_master/datasets1/VOCdevkit/VOC2007/Annotations/'
VOC_2013_trainval_image_set_filename = 'D:/3/ssd_keras_1_master/datasets1/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt'
VOC_2013_test_image_set_filename = 'D:/3/ssd_keras_1_master/datasets1/VOCdevkit/VOC2007/ImageSets/Main/test.txt'
...
val_dataset.parse_xml(images_dirs=[VOC_2013_images_dir],
                      ...
                      ret=False)
predict_generator = val_dataset.generate(batch_size=95,
                                         shuffle=False,
                                         label_encoder=None,
...
batch_holder = np.zeros((95, img_height, img_width, 3))


# img_dir =  "G:/ssd_keras_1_master/row image/"
# img_dir =  "D:/3/SWIPENet_master2/testdataimage"
# img_dir = 'D:/3/ssd_keras_1_master/datasets1/VOCdevkit/VOC2007/JPEGImages/'

# img_dir =  "G:\ssd_keras_1_master\datasets1\VOCdevkit\VOC2007\JPEGImages/"
for i,img, in enumerate(batch_filenames):
    img = img
...
#     img = os.path.join(img_dir, img)
    ...
    y_true = np.array(batch_original_labels[i])
    b = np.hstack(( np.ones((y_true.shape[0], 1)),y_true))
    print('this is b', b)

    print("y_true",b.shape)
    ...
    print("pred _size",y_pred_thresh[i].shape)
    # Roc = roc_curve( b, y_pred_thresh, thresholds)
