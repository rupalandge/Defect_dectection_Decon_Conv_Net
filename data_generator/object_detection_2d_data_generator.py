...
class DataGenerator:
    ...
    def parse_xml(self,
        ...
        for images_dir, image_set_filename, annotations_dir in zip(images_dirs, image_set_filenames, annotations_dirs):
            ...
            for image_id in it:
                frame = '{}'.format(image_id) + '.jpg'
                # print(filename)
                self.filenames.append(os.path.join(images_dir, frame))
                ...
                if not annotations_dirs is None:
                    ...
                    folder = soup.frame.text  # In case we want to return the folder in addition to the image file name. Relevant for determining which dataset an image belongs to.
    ...
    def generate(self,
        ...
        while True:
            ...
            if not (self.images is None):
                ...
                batch_filenames = self.filenames[current:current+batch_size]
                print("This is batch_filename",batch_filenames)
            ...
            if not (self.image_ids is None):
                ...
                print("batch_image_id",batch_image_ids)
            else:
            ...
            if not (label_encoder is None or self.labels is None):
                print("labels_encoder",label_encoder)
                ...
                if ('matched_anchors' in returns) and isinstance(label_encoder, SSDInputEncoder):
                    ...
                    print("this is  batch_Y_encoded",batch_y_encoded)
